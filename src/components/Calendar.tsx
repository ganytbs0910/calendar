...
interface CalendarProps {
  ...
  /** Tapping an あとでやる todo (month grid or the day-events sheet) hands it
   * here instead of editing it in-place — the caller opens the same editor
   * screen used for normal events (AddEventModal's laterMode), so editing a
   * todo feels the same as editing an event. */
  onTodoPress?: (task: Task) => void;
}
...
export const Calendar = forwardRef<CalendarRef, CalendarProps>(({onDateSelect, onDateDoubleSelect, onEventPress, onDateRangeSelect, onMonthChange, hasPermission: hasPermissionProp, fullscreenMode, filterColor, selectionMode, selectedEventKeys, onToggleEventSelection, onEventLongPressSelect, eventStore, onTodoPress}, ref) => {
